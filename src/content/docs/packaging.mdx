...
Congratulations! You've completed the Getting Started section. Continue to [Fundamentals](/docs/fundamentals/overview) to learn about VS architecture and services.
